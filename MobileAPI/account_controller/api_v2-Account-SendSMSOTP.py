...
def test_sign_in(api_headers):
    sign_in_url = 'https://onlinebankingapi.cdigital.am/api/v2/Account/SignIn'
    sign_in_data = {
        "userName": "Beniamin",
        "password": "Aa-12345"
    }
...
def test_get_branches(api_headers):
    ...
    response = requests.post('https://onlinebankingapi.cdigital.am/api/v2/Account/SendSMSOTP', json=budget_acc,
